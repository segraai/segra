      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid md:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3 text-primary-foreground/80">
              <li><a href="/about#team" className="hover:text-accent transition-colors">Team</a></li>
              <li><a href="/about#our-story" className="hover:text-accent transition-colors">Our Story</a></li>
